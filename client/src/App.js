...
import Write from "./pages/Blog/Write.js";
import SinglePost from "./pages/Blog/MainPost.js";
import BlogProfile from "./pages/auth/profile.js";
import AOS from "aos";
    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/profile" element={<BlogProfile />}></Route>

          <Route exact path={`/blog/:title`} element={<SinglePost />}></Route>
      <Route exact path="/blog/write" element={<Write />}></Route> */}
