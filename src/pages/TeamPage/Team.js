            ...
            <div className="app-dev">
              ...
              <div className="first">
                ...
                <p className="desc">
                  ...
                  stay ahead of the competition. Our app development services
                  will help you create a custom mobile app that is tailored to
                  your business needs and goals. From concept to launch, our
                  team of experts will work with you every step of the way to
                  create an app that is user-friendly, visually appealing, and
                  highly functional
                </p>
              </div>
            </div>
